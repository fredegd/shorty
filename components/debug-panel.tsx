    ...
    return (
        <>
            ...
            <Button
                ...
                className="fixed bottom-6 right-6 z-50 border-orange-300 text-orange-700 hover:bg-orange-50 shadow-lg"
            >
                    ...
                    <Card className="border-dashed border-orange-300 bg-orange-50">
                        <CardHeader className="pb-4">
                            <div className="flex items-center gap-2">
                                ...
                                <CardTitle className="text-lg text-orange-800">Statistics</CardTitle>
                            </div>
